...
export function HeroSection() {
  ...
  return (
    <section ref={heroRef} className="min-h-screen flex flex-col justify-center pt-20 bg-background">
      <div className="mx-auto max-w-4xl px-6 py-24 lg:py-32 text-center">
        ...
        {/* Main Heading */}
        <h1 className="hero-title mt-10 font-serif text-5xl sm:text-6xl lg:text-7xl font-normal text-foreground leading-[1.1]">
          Precision in Global Trade
        </h1>
        
        {/* Description */}
        <p className="hero-description mt-8 text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
      ...
      {/* Scroll Indicator */}
      <div className="hero-scroll flex-shrink-0 pb-12 flex flex-col items-center">
        <div className="w-px h-16 bg-gradient-to-b from-transparent to-muted-foreground/40" />
        <span className="mt-4 text-[10px] uppercase tracking-[0.2em] text-muted-foreground/60">
          Scroll
        </span>
      </div>
    </section>
